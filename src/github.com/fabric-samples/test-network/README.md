...
```bash
export $(./setOrgEnv.sh Hosp2 | xargs)
```

(Note bash v4 is required for the scripts.)

You will now be able to run the `peer` commands in the context of Hosp2. If a different command prompt, you can run the same command with Hosp1 instead.
