...
setGlobals 2
set -x
peer channel update -f org3_update_in_envelope.pb -c ${CHANNEL_NAME} -o orderer.eurisko:7050 --ordererTLSHostnameOverride orderer.eurisko --tls --cafile "$ORDERER_CA"
{ set +x; } 2>/dev/null
